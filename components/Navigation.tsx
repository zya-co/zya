...
export const Navigation = (props) => {
  ...
  const navData = props.props.data.navigation.navItem.map((navitem) => {
    return {
  ...
  const ctaData = {
    label: props.props.data.navigation.cta.ctaLabel,
    link: props.props.data.navigation.cta.ctaLink
  }

  return (
    <div className={`mainNav ${styles.mainNav}`} ref={container}>
      <a className={styles.mainNav__logo} href='/'>
