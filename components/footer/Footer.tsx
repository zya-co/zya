        ...
        {/* <div className={styles.footer__linklist}>
          ...
          <div className={styles.footer__nav}>
            <div className={styles.footer__nav__column}>
              <h4 className={styles.footer__nav__column__header}>Zya</h4>
              <Link className={styles.footer__navlink} href='/mission'>Our Mission</Link>
              <Link className={styles.footer__navlink} href='/approach'>Our Approach</Link>
              <Link className={styles.footer__navlink} href='/media'>Media</Link>
            </div>
            <div className={styles.footer__nav__column}>
              <h4 className={styles.footer__nav__column__header}><Link className={styles.footer__navlink} href='/convero'>Convero</Link></h4>
            </div>
            <div className={styles.footer__nav__column}>
              <h4 className={styles.footer__nav__column__header}>Our Ecosystem</h4>
              <Link className={styles.footer__navlink} href='/our-founders'>Our Founders</Link>
              <Link className={styles.footer__navlink} href='/team'>Our Team</Link>
              <Link className={styles.footer__navlink} href='/team'>Our Partners</Link>
            </div>
            <div className={styles.footer__nav__column}>
              <h4 className={styles.footer__nav__column__header}><Link className={styles.footer__navlink} href='/blog'>The Blog</Link></h4>
            </div>
            <div className={styles.footer__nav__column}>
              <Button 
                color="mineral-white"
