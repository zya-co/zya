---
meta:
  title: 'Meet the Zya Team – Experts in Science, Innovation, and Nutrition'
  description: 'Get to know the scientists, advisors, and industry leaders driving Zya’s mission to revolutionize food and nutrition through enzyme-powered FoodTech solutions.'
blocks:
  - spacing:
      padding:
        top: 0
    ...
    blocks:
      ...
      - color: mineral-white
        richtext: |
          ## Building a foundation for better nutrition through strategic partnerships and expertise.
        margins:
          left: 1
        marginsMobile:
          top: 1
      ...
      - color: mineral-white
        richtext: |
          Zya’s ecosystem is built on a blend of scientific rigor, innovative thinking, and collaborative partnerships. Our commitment to enhancing everyday nutrition extends beyond our team to a network of experts, researchers, and advisors who contribute their unique knowledge to drive our vision forward.
        margins:
          top: 3.5
        marginsMobile:
          top: 1
  ...
  - spacing:
    ...
    blocks:
      ...
      - color: morpho-teal
        ...
        _template: textBlock
    _template: dynamicBlock
  - advisoryHead: Meet the team
    advisorySubhead: 'Visionaries with a purpose:'
    advisors:
      - name: Joshua Sauer
        image:
        ...
        otherTitle: 'Josh is driven by a passion to make nutrition healthier, tastier, and accessible to all.'
        bio: 'His mission is to connect groundbreaking bioscience innovations with everyday life, ensuring they create real, tangible benefits for people. With a chemistry degree and a PhD in bioscience from the University of Oxford, Josh combines technical expertise with a visionary approach to nutrition.'
        button:
      ...
      - name: Nelisa Tebeka
        image:
          image: /media/founders/nelisa_tebeka_masked.png
          fullWidth: true
        degree: PhD
        title: Principal Scientist
        otherTitle: Nelisa is energized by developing scientific tools that fuel real-world breakthroughs
        bio: 'Her aim is to translate molecular biotechnology into tangible applications. With a PhD from the University of Oxford, postdoctoral research at Imperial College London, and biotech industry experience, she combines wide-ranging technical skillset to help drive Zya''s mission.'
        button:
          link: 'https://www.linkedin.com/in/nchimunyanelisatebeka/'
  ...
  - spacing:
    ...
    blocks:
      - color: ''
        ...
        _template: textBlock
      - richtext: |
          At Zya, we're on a mission to improve consumer health using the power of enzymes.

          We're a small, but growing team and are particularly intentional about cultivating a thriving company culture.
        margins:
          top: 0
          right: 2
          bottom: 0
        ...
        _template: textBlock
      - richtext: |
          At Zya, revolutionizing the food industry is more than a job - it’s a career-defining journey, unlike anything you’ve experienced before.
        ...
        _template: textBlock
      - richtext: |
          <Cta color="lichen" label="Check out our job openings" link="https://zya.recruit.charliehr.com/careers" />
        margins:
          top: 0.5
          left: 7
        width: 5
        _template: textBlock
    _template: dynamicBlock
  - advisoryHead: The Board
    advisorySubhead: Driving Zya forward
    advisors:
      - name: Joshua Sauer
        image:
          image: /media/founders/joshua_sauer_uncropped.webp
          circleFrame: true
          monochrome: true
        degree: PhD
      ...
      - name: Christina Ulardic
        image:
          image: /media/advisors/ChristinaUlardic.webp
          circleFrame: true
          monochrome: true
        title: Investor Director
        otherTitle: Agri Foodtech Partner at Astanor Ventures
        bio: 'Christina is a partner at Astanor with over a decade working alongside agri-food entrepreneurs across Africa, Asia, the Americas, and Europe. She is driven by a simple belief: that food systems should be resilient, equitable, and future-proof. A pioneer in remote field-sensing technologies for de-risking agricultural finance - now adopted by the World Food Programme - she brings deep expertise from Swiss Re, the UN, and the German Federal Ministry for the Environment.'
        button:
          link: 'https://www.linkedin.com/in/christina-ulardic-b585b4/'
      - name: Niels Wicke
        image:
          image: /media/founders/niels_wicke_uncropped.webp
          circleFrame: true
          monochrome: true
        degree: PhD
        title: Founder Director
      ...
      - name: Wes Selke
        image:
          image: /media/advisors/Wes-copy.jpg
          circleFrame: true
          monochrome: true
        title: Board Observer
        otherTitle: Managing Partner at Better Ventures
        bio: 'Wes is Founding Partner of Better Ventures, investing in food, agriculture, biomanufacturing, and materials science. He believes our food system is broken -  and that science can fix it. His backing of Zya reflects a conviction that biology and technology can improve human and planetary health at once. Wes brings 25 years of venture experience, an MBA from Haas, and a belief that what we eat shapes everything. He lives in Oakland with his wife and three kids.'
        button:
          link: 'https://www.linkedin.com/in/wdselke/'
      - name: Joanna Green
        image:
          image: /media/advisors/Joanna.jpg
          circleFrame: true
          monochrome: true
        degree: PhD
        title: Investor Director
        otherTitle: Life sciences Partner at Ahren innovation capital
        bio: 'Joanna is a partner at Ahren, where she leads life sciences investments across platform therapeutics, biomanufacturing, and tools. Her work with Zya reflects a belief that the most powerful solutions sit at the intersection of biology and everyday life. Before Ahren, she advised multinational healthcare companies at BCG. Joanna holds a PhD in fetal immunology and a First-Class Master''s and undergraduate degree from Oxford.'
        button:
          link: 'https://www.linkedin.com/in/joanna-green-5bb34283/'
    _template: advisoryTeam
  - bgColor: mineral-white
    ...
    advisors:
      - name: Kevin Powell
        ...
        degree: PhD
        title: Advisor
        otherTitle: Former global innovation leader at Gillette/P&G
        ...
        button:
          link: 'https://www.linkedin.com/in/kevin-powell-3517074/'
      - name: Gary Frost
        image:
      ...
      - name: Jacquie Chick
        image:
          ...
          monochrome: true
        title: Advisor
        otherTitle: 'Brand Planner & Strategist. Past clients include: Unilever, Kraft Heinz, Kellogg''s'
  ...
  - anchor: partners
    ...
    blocks:
      - richtext: "#### Collaborative effort:\n\n# Innovation thrives on partnerships\_\n"
        ...
        _template: textBlock
      - richtext: |
          #### At Zya, we believe that collaboration is key to accelerating progress. Our partnerships span various sectors, including research institutions, food manufacturers, and industry leaders.
        margins:
          top: 1
        marginsMobile:
          top: 0.5
      ...
      - richtext: "### Our work with research organisations and universities ensures that our enzyme innovations remain at the cutting edge of science.\_\n"
        ...
        _template: textBlock
    _template: dynamicBlock
  - affilationHead: We collaborate with world-leading scientists to push the boundaries of innovation.
    collaborators:
  ...
  - spacing:
    ...
    blocks:
      ...
      - color: mineral-white
        richtext: |
          ### Our ecosystem is designed not just for innovation but for practical application.

          We work closely with CPG companies to ensure that our enzyme solutions, like Convero, seamlessly integrate into existing products, adding nutritional value while preserving taste and consumer appeal.
        margins:
          top: 0
          left: 2
        marginsMobile:
  ...
  - introHead: |
      ...
      ========
    introLeft: |
      #### Zya was founded by two scientists, Dr. Joshua Sauer and Dr. Niels Wicke, both with deep expertise in biochemistry and biotechnology.
    ...
    founders:
      - name: Joshua Sauer
        ...
        bio: |
          #### Josh is driven by a passion to make nutrition healthier, tastier, and accessible to all.

          His mission is to connect groundbreaking bioscience innovations with everyday life, ensuring they create real, tangible benefits for people. With a chemistry degree and a PhD in bioscience from the University of Oxford, Josh combines technical expertise with a visionary approach to nutrition.
        button:
          link: 'https://www.linkedin.com/in/josh-sauer-phd/'
        biolink:
          label: Science bio
