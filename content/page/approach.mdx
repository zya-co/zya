...
blocks:
  ...
  - bgImage:
    ...
    content: >
      <enzyme image="/media/Fibonacci Scale Skipping 5.svg" alt="enzyme" />


      ## We are using creative bioscience to apply the same transformative
      principle to other nutrients.
